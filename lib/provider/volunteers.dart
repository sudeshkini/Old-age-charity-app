...
import 'package:summer_home/models/volunteer.dart';
import 'dart:convert';
...
class Volunteers with ChangeNotifier {
  ...
  Future<void> addwork(Volunteer vol) async {
    final url =
        Uri.parse('https://summer-home-f1a64-default-rtdb.asia-southeast1.firebasedatabase.app/volunteers.json?auth=$authToken');
